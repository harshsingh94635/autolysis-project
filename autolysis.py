# Create the full project scaffold and write a production-ready `autolysis.py`
# plus a root README, LICENSE, and the three required dataset output folders.

import os, textwrap, json, pathlib, sys, base64, io

root = "/mnt/data/karo_autolysis_project"
os.makedirs(root, exist_ok=True)

# --- Write autolysis.py ---
autolysis_code = r'''# /// script
...
if __name__ == "__main__":
    main()
'''
autolysis_path = os.path.join(root, "autolysis.py")
with open(autolysis_path, "w", encoding="utf-8") as f:
    f.write(autolysis_code)

# --- Write root README with instructions ---
root_readme = """# KaroStartup Project 2 – Automated Analysis
